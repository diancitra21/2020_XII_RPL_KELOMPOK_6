                ...
                <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        <div id="datatables-example_wrapper"
                             ...
                             <div class="row">
  <div class="col-sm-6">
 </div></div></div></div><form action="/history-peminjaman" method="GET" class="text-right" style="float:right">
...
<label>:</label>
<label>Rp. {{number_format($data->bor_fine, 1, ',', '.')}}</label>
</div>
<br>
<?php
$jml_bayar = 0;
...
&nbsp;
 <input type="number" min="1" maxlength="4" class="form-control col-12" required name="pay_fine"><input type="hidden" value="{{$data->bor_id}}" name="bor_id">
 </div>
</div>
 </div>
