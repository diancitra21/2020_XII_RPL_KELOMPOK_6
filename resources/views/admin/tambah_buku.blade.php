                  ...
                  <div class="col-md-12 panel-body">
                    <div class="col-md-12">
                     <div class="col-md-12">
                      ...
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input type="number" min="1" maxlength="4" name="jumlah_halaman" class="form-text mask-date_time" required="">
                        <span class="bar"></span>
                        <label>Jumlah Halaman</label>
                      </div>

                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input type="number" min="1" maxlength="4"  name="total_buku" class="form-text mask-cep" required="">
                        <span class="bar"></span>
