              ...
              <div class="col-sm-12">
                <div class="col-md-12 panel">
                  ...
                  <div class="col-md-12 panel-body">
                    <div class="col-md-12">
                     <div class="col-md-12">
                      <form action="{{URL::to('/Update',$visitor->vst_id)}}" method="POST">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input type="text" name="nama" class="form-text mask-date" required=""value="{{$visitor->vst_name}}">
                        <span class="bar"></span>
                      ...
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <h4>Jabatan</h4>
                        <select name="jabatan" class="form-control" value="{{$visitor->pst_position}}">
                          @foreach($pst as $data)
                      ...
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        ...
                        <select name="tujuan" class="form-control"value="{{$visitor->pps_purpose}}">
                          @foreach($pps as $data)
