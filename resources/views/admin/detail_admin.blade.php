  ...
  <section class="panel">
    <div class="panel-body bio-graph-info">
      <div class="row">
        ...
        <div class="bio-row">
          <p><span>E-Mail </span>: admin@gmail.com</p>
        </div>
        <div class="bio-row">
...
<div id="edit-profile" class="tab-pane active">
  <section class="panel">
    <div class="panel-body bio-graph-info">
      ...
      <div class="col-md-9">
        <label for="name" >Usename</label>  <input id="name" type="text" class="form-control " name="name" value="Admin" required="" autocomplete="name" autofocus="">
        </div>
       
          <div class="col-md-9">
            <label for="name" >Email</label>  <input id="name" type="text" class="form-control " name="name" value="Admin@gmail.com" required="" autocomplete="name" autofocus="">
        </div>
          ...
          <div class="col-md-9">
            <label for="name" >Password</label>  <input id="name" type="text" class="form-control " name="name" value="Admin123" required="" autocomplete="name" autofocus="">
        </div>
