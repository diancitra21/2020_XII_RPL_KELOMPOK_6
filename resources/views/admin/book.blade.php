      ...
      <div class="panel-body">
        <div class="responsive-table">
          <div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
            <div class="row">
              <div class="col-sm-6">
                <a href = "{{URL::to('/tambah_buku')}}" class="btn btn-3d btn-danger mr-2">Tambah Buku</a>              <a href="{{URL::to('/trash')}}" class="btn btn-3d btn-outline btn-danger icon-refresh">Restore</a>                                                          <br><br><br>

              </div>
                 </div></div></div><form action="/book/cari" method="GET" class="text-right" style="float:right">
                    ...
                    <div class="col-sm-12"><table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
                      ...
                      <tr role="row" class="odd">
                        ...
                        <td>
                          ...
                          <a href = "{{URL::to('edit-book/'.$data->bok_id)}}" class="btn btn-outline btn-info fa fa-pencil-square-o"></a>
                        
                        <a href="{{URL::to('delete/'.$data->bok_id)}}">
                          <input type="hidden" name="bok_id" value="<?=$data->bok_id?>">
